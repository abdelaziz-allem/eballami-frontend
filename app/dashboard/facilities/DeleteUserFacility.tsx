...
import { deleteUserFacility } from "@/lib/db/userfacilityCrud";

const DeleteUserFacility = ({ userFacilityId }: { userFacilityId: number }) => {
  ...
  async function onSubmit() {
    try {
      ...
      await deleteUserFacility(userFacilityId);
...
export default DeleteUserFacility;
